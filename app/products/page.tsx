              ...
              <div className="flex flex-col lg:flex-row gap-8 mb-12">
                ...
                <div className="lg:w-2/3 flex flex-col justify-start">
                  <p className="text-gray-700 text-sm leading-relaxed">
                    ...
                    Each product is defined by precise craftsmanship, carefully selected materials, and a distinctive design language. From statement 
                    seating to elegant tables and accent pieces, the collection reflects a commitment to quality and design integrity.
                    
                    Homelogy Style furniture brings character, elegance, and presence into modern interiors, shaping spaces that reflect 
                    a cultivated lifestyle.
                  </p>
                </div>
              </div>
